...
public class DOSaleComplete {
    ...
    public static void main(String args[]) {
        ...
        /* NOTE: All information regarding the available objects within payflow_jar can be found in the API doc
           found under the "Docs" directory of the installed SDK.  You will also need to refer to the Payflow Gateway
           Developer's Guide found at https://developer.paypal.com/docs/classic/payflow/integration-guide.
        ...
        while (trxCount <= 3 && !RespRecd) {
            ...
            if (Resp != null) {
                ...
                if (TrxnResponse != null) {
                    ...
                    System.out.println("Payment Advice Code (PAYMENTADVICECODE) = " + TrxnResponse.getPaymentAdviceCode());
                }

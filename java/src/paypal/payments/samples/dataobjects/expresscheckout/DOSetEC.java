	...
	public static void main(String args[]) {
		...
		if (Resp != null) {
			...
			if (TrxnResponse.getResult() == 0) {
				...
				System.out.println("");
				System.out.println(
						"Make sure you are logged into Developer Central (https://developer.paypal.com) before continuing.");
				System.out.println("");
				...
				// Before you can use the PayPal Sandbox with a Gateway account you'll need to
				// do the following:
				// To setup a PayPal Sandbox account to work with a Payflow Pro account you will
				// need to go to
				// https://developer.paypal.com and create an account. Once you have access to
				// the Sandbox then
				// you will be able to set up test business accounts, premier accounts and
				...
				// If the SET operation succeeds, you will get a secure session token id in the
				// response of this

...
public class DORecurringModify {
	...
	public static void main(String args[]) {
		...
		RecurringModifyTransaction trans = new RecurringModifyTransaction(user, connection, recurInfo, inv, card,
				PayflowUtility.getRequestId());

		// If all you want to do is modify the customer data, like address, e-mail or
		// phone number you just
		// need to pass "null" for the BaseTender (CardTender) object. This would
		// include not setting
		// the amount either.

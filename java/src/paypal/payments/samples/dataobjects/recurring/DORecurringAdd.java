...
public class DORecurringAdd {
	...
	public static void main(String args[]) {
		...
		// Creating a profile where our customer is paying three installments of $25.75
		// with a shipping
		// charge of $9.95. So, our first payment will be $25.75 + 9.95 with two more
		// payments of $25.75 due.
		//
		...
		// CVV2 is used for Optional Transaction (Sale or Authorization) Only. It is not
		...
		RecurringAddTransaction trans = new RecurringAddTransaction(user, connection, inv, card, recurInfo,
				PayflowUtility.getRequestId());

		// Use ORIGID to create a profile based on the details of another transaction.
		// See Reference Transaction.
		...
		if (resp != null) {
			...
			if (recurResponse != null) {
				...
				if (recurResponse.getTrxResult() != null) {
					...
					// If this value is true, you will probably receive a result code 19, Original

...
Namespace PayPal.Payments.Samples.VB.DataObjects.BasicTransactions
    ...
    Public Class DOSaleCompleteVB
        ...
        Public Shared Sub Main(ByVal Args() As String)
            ...
            Dim Amt As New Currency(New Decimal(25.25), usCurrency)
            ...
            Dim CC As New CreditCard("5105105105105100", "1215")
            ...
            Dim trxCount As Integer = 1
            Dim RespRecd As Boolean = False

            While trxCount <= 3 And RespRecd = False
                ...
                If Not (Resp Is Nothing) Then
                    ...
                    If Not (TrxnResponse Is Nothing) Then
                        ...
                        ' symbol will be used.
                        Console.WriteLine("Amount of Transaction (AMT) = " + Decimal.Parse(TrxnResponse.Amt).ToString("c", us))
                    End If
                    ...
                    Select Case TrxnResponse.Result
                    ...
                    Case Is < 0  ' Transaction failed.
                        ...
                        Case 0
                            ...
                            If TrxnResponse.AVSAddr <> "Y" Then
                            ...
                            If TrxnResponse.AVSZip <> "Y" Then
                                ...
                                ' Here you might want to put in code to flag or void the transaction depending on your needs.
                            End If
                            If TrxnResponse.CVV2Match <> "Y" Then
                                ' Display message that transaction was not accepted.  At this time, you

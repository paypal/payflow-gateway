...
Namespace PayPal.Payments.Samples.VB.DataObjects.BasicTransactions
    ...
    Public Class DOSaleCompleteVB
        ...
        Public Shared Sub Main(ByVal Args() As String)
            ...
            'Dim Amt As New Currency(New Decimal(225.25), usCurrency)
            Dim Amt As New Currency(New Decimal(225.25), "USD")
            ...
            ' See the section, "Submitting Soft Merchant Information" in te Payflow Pro Developer's Guide for more information.
            ...
            'CustInfo.CustCode = "Cust123"  ' Customer Code
            ...
            '          
            ' For these fields to be echoed back in the response, you need to set the ECHODATA object. 
            ...
            '
            'Dim MerchInfo As New MerchantInfo

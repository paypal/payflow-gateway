...
Namespace PayPal.Payments.Samples.VB.DataObjects.Misc
    ...
    ''' It demonstrates how to attach a ClientInfo object and add custom transaction headers.
    ...
    Public Class DOClientInfo
        ...
        Public Shared Sub Main(ByVal Args As String())
            ...
            ' Create a new Client Information data object and attach it to the transaction.
            ' This is used to pass wrapper/integration information (e.g. cart name, version).
            Dim ClInfo As ClientInfo = New ClientInfo
            Trans.ClientInfo = ClInfo

            ' Add a custom transaction header.

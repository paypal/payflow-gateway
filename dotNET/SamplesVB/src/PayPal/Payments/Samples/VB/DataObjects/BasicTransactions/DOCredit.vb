...
Namespace PayPal.Payments.Samples.VB.DataObjects.BasicTransactions
    ...
    Public Class DOCredit
        ...
        Public Shared Sub Main(ByVal Args As String())
            Console.WriteLine("------------------------------------------------------")
            Console.WriteLine("Executing Sample from File: DOCredit.vb")
            Console.WriteLine("------------------------------------------------------")
            ...
            Dim Trans As CreditTransaction = New CreditTransaction(User, Connection, Inv, Card, PayflowUtility.RequestId)

...
Namespace PayPal.Payments.Samples.VB.DataObjects.Recurring
    ...
    Public Class DORecurringCancel
        ...
        Public Shared Sub Main(ByVal Args As String())
            Console.WriteLine("------------------------------------------------------")
            Console.WriteLine("Executing Sample from File: DORecurringCancel.vb")
            Console.WriteLine("------------------------------------------------------")
            ...
            Dim Trans As RecurringCancelTransaction = New RecurringCancelTransaction(User, Connection, RecurInfo, PayflowUtility.RequestId)
